...
def logout():
    ...
    st.markdown(f'<meta http-equiv="refresh" content="0; url={_authentik}/application/o/centinela-ai/end-session/?post_logout_redirect_uri={_authentik}/centinela/">', unsafe_allow_html=True)
    st.stop()

# Configuración de Base de Datos
DB_CONFIG = {
    "host": os.getenv("DB_HOST", "10.4.3.23"),
    "database": os.getenv("DB_NAME", "centinela_db"),
    "user": os.getenv("DB_USER", "centinela_user"),
    "password": os.getenv("DB_PASSWORD", "centinela_sec_db_2026")
}
