"""
Re-scan the 3 Local/siat/* folder assets in place (code snapshot 2026-08-25/26 (fresh zips subidos por el usuario a docs/)) with the
...
User decision 2026-08-28: "Re-escanear ahora las carpetas tal cual".
"""
import sys
