# -*- coding: utf-8 -*-
"""
Reporte de seguridad del grupo GitLab `teca` -- mismo formato detallado que los reportes de
...
teca es un proyecto SEPARADO de SIAT/SIDECO -- este reporte solo lee los activos GitLab/teca/*.

Emite:
  * artefacto HTML  -> scratchpad/reporte_teca_2026-09-01.html   (para publicar)
  * PDF house-style -> /app/docs/reportes/Reporte_TECA_Centinela_2026-09-01.pdf  (vía main.py)
"""
import json, html, re, collections, datetime, sys, os

SRC = "/tmp/claude-1000/-opt-centinela-ai/d6ed2905-f3a4-419f-a872-39919860cf03/scratchpad/teca_scan_2026-09-01.json"
OUT_HTML = "/tmp/claude-1000/-opt-centinela-ai/d6ed2905-f3a4-419f-a872-39919860cf03/scratchpad/reporte_teca_2026-09-01.html"

def G(t, e, a, r, c): return dict(t=t, enc=e, afecta=a, resolver=r, code=c)

# GUIDE neutralizado (sin referencias a SIDECO/SIAT -- teca es otro proyecto)
GUIDE = {
...
def main():
    ...
    HTML = f'''<title>Seguridad del grupo TECA</title>
...
<div class="wrap">
  <header class="masthead">
    ...
    <h1>Seguridad del grupo TECA: hallazgo por hallazgo, dónde está y cómo se corrige</h1>
    <p class="lede">Análisis completo de los <b>{len(assets)} repositorios</b> del grupo GitLab
      <code>teca</code>. Cada hallazgo indica qué encontramos, en qué afecta, si se corrige sin actualizar
  ...
  <footer>
    ...
    <code>desarrollo</code> cuando existe) de cada repositorio del grupo <code>teca</code>. El PDF con la marca
    de Centinela está en <code>/opt/centinela-ai/docs/reportes/Reporte_TECA_Centinela_2026-09-01.pdf</code>.
