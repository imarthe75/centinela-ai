...
- **Kubernetes Hardening (`K8S-PRIVILEGED-CONTAINER`, `K8S-HOSTPATH-MOUNT`, `K8S-WRITABLE-ROOT-FS`):**
  ...
  - **Obligatorio:** `automountServiceAccountToken: false` a menos que sea strictly necesario.
...
- **Prohibición de Backdoors & Controllers Sandbox:** Queda strictly prohibido desplegar controladores de prueba (`LocalAuthController`, `TestSandboxController`) en entornos productivos o staging (`CWE-288` / `CWE-798`).
