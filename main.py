...
def get_vault_client():
    ...
    vault_addr = os.getenv("VAULT_ADDR", "***REMOVED-SECRET***")
...
async def get_system_config():
    ...
    defaults = [
        ...
        {"key": "AI_MODEL", "value": os.getenv("AI_MODEL", "***REMOVED-SECRET***"), "category": "LLM_AGENTS", "description": "Modelo de LLM en ejecución"},
        ...
        {"key": "OLLAMA_BASE_URL", "value": os.getenv("OLLAMA_BASE_URL", "***REMOVED-SECRET***"), "category": "LLM_AGENTS", "description": "URL base de Ollama local"},
...
async def get_provider_models(provider: str, api_key: Optional[str] = None):
    ...
    try:
        if "nvidia" in prov:
            ...
            models = ["***REMOVED-SECRET***", "gemini-1.5-pro-latest"]
